...
module clock_resource(clk_12MHz, clk_148_5MHz, clk_100MHz, reset, 
  locked, clk_in1)
/* synthesis syn_black_box black_box_pad_pin="clk_12MHz,clk_148_5MHz,clk_100MHz,reset,locked,clk_in1" */;
  output clk_12MHz;
  output clk_148_5MHz;
  output clk_100MHz;
  input reset;
